...
import 'features/restaurants/domain/usecases/delete_favorites_usecase.dart';
...
import 'features/restaurants/domain/usecases/list_favorites_usecase.dart';
...
Future<void> injectDependencies() async {
  ...
  serviceLocator.registerLazySingleton(
      () => ListFavoritesUsecase(favoritesRepository: serviceLocator()));
  serviceLocator.registerLazySingleton(
      () => DeleteFavoritesUsecase(favoritesRepository: serviceLocator()));
  ...
  serviceLocator.registerLazySingleton(
    () => GetRestaurantDetailsUsecase(
      restaurantsRepository: serviceLocator(),
  ...
  serviceLocator.registerLazySingleton(
    () => RestaurantsBloc(
      ...
      listFavoritesUsecase: serviceLocator(),
      deleteFavoritesUsecase: serviceLocator(),
    ),
  );
}
